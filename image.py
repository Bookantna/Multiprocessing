...
if __name__ == '__main__':
    ...
    #brighten image
    bright_im = brighten(im, 1.7)
    bright_im.write_image("brightenned.png")
    
    # contrast Image
    contrast_im = adjust_contrast(im, 2)
    contrast_im.write_image("contrast.png")

    # blur Image
    blur_im = blur(city, 15)
    blur_im.write_image("City_blurK15.png")'''
    ...
    sobel_x.write_image("Sobelx.png")
    sobel_y = apply_kernel(city, sobel_y_kernel)
    sobel_y.write_image("Sobely.png")

    combine = combine_images(sobel_x, sobel_y)
    combine.write_image("CombineSobel.png")
